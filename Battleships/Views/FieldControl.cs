...
namespace Battleships.Views
{
    public partial class FieldControl : UserControl
    {
        ...
        public void Configure(Field field, bool fogOfWar)
        {
            if (configured)
        ...
        private void PaintShip(Graphics graphics, Ship ship,
        ...
        private static Dictionary<Domain.Point, Rectangle> GeneratePointToRectangle(Field field, int width, int height)
        {
