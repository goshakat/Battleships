...
namespace Battleships.AI
{
    public static class FieldExtensions
    {
        ...
        public static Point GenerateRandomShot(this Field field)
        {
        ...
        public static bool ArrangeShipsAutomatically(this Field field)
        {
            for (var i = 0; i < 1000; i++)
            {
        ...
        private static void RemoveAllShips(this Field field)
        {
            foreach (var ship in field.GetShips().Where(it => it.Position != null))
                field.PutShip(ship, new Point(-1, -1));
        }

        private static bool TryArrangeShips(this Field field, int steps)
        {
